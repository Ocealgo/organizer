...
export default function WorkspaceDashboard() {
  ...
  const tabs = [
    ...
    { id: 'checklist' as WTab, label: 'Tasks' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0d1117' }}>
      {/* Header */}
      <div style={{ background: '#000000', padding: '16px 20px 0' }}>
        <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 11, letterSpacing: 3, textTransform: 'uppercase', marginBottom: 2 }}>Founders Only</div>
        <div style={{ fontSize: 20, fontWeight: 900, color: '#fff', marginBottom: 14 }}>Workspace</div>

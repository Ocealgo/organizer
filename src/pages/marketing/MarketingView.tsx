export default function MarketingView() {
  return (
    <div style={{ minHeight: '100vh', background: '#0d1117', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 32 }}>
      <div style={{ background: 'rgba(245,158,11,0.12)', color: '#f59e0b', fontSize: 11, fontWeight: 800, padding: '4px 12px', borderRadius: 99, letterSpacing: 1, marginBottom: 16 }}>COMING SOON</div>
      ...
      <div style={{ marginTop: 32, background: '#161b22', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 16, padding: '16px 20px', maxWidth: 300, width: '100%' }}>
        <div style={{ fontSize: 12, color: '#f59e0b', fontWeight: 700, marginBottom: 8 }}>Features being built:</div>
